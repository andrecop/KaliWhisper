...
class WhisperApp:
    ...
    def _setup_ui(self):
        ...
        self.play_btn.grid(row=0, column=1, sticky="ew", padx=(5, 5))
        ...
        self.start_btn.grid(row=0, column=2, sticky="ew", padx=(5, 0))
        ...
        self.bottom_btn_frame.columnconfigure(2, weight=1)
        ...
        self.ui_lang_btn.grid(row=0, column=0, sticky="ew", padx=(0, 5))
        ...
        self.save_audio_btn.grid(row=0, column=1, sticky="ew", padx=(5, 5))
        ...
        self.save_btn.grid(row=0, column=2, sticky="ew", padx=(5, 0))
        
        self.close_btn_frame = ctk.CTkFrame(main_frame, fg_color="transparent")
        self.close_btn_frame.pack(fill=tk.X, pady=(10, 0))
        self.close_btn_frame.columnconfigure(0, weight=1)
        self.close_btn_frame.columnconfigure(1, weight=3)
        ...
        self.visualizer_container.grid(row=0, column=0, sticky="ew", padx=(0, 5))
        ...
        self.save_and_close_btn.grid(row=0, column=1, sticky="ew", padx=(5, 0))
