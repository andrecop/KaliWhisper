...
class WhisperApp:
    ...
    def _setup_ui(self):
        ...
        self.reset_btn = ctk.CTkButton(button_frame, text="🗑 Reset", command=self._reset_transcription, font=("Segoe UI", 11, "bold"), height=38, fg_color="#ef4444", hover_color="#dc2626", text_color="#ffffff", width=100)
        ...
        self.ui_lang_btn = ctk.CTkButton(
            ...
            fg_color="#18181b", border_color="#27272a", border_width=1, hover_color="#27272a",
            text_color="#fafafa", font=("Segoe UI", 11, "bold"), corner_radius=8, width=100
        )
        self.ui_lang_btn.pack(side=tk.LEFT, padx=(0, 5))
        ...
        self.visualizer_container = ctk.CTkFrame(self.close_btn_frame, fg_color="#18181b", width=100, height=38, border_color="#27272a", border_width=1)
        self.visualizer_container.pack(side=tk.LEFT, padx=(0, 5))
